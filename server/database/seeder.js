...
async function seed() {
  ...
  try {
    ...
    const users = [
      { id: 2, nama: 'Budi Santoso',    email: 'budi@gmail.com', password: hash, role: 'PENYEWA', no_telp: '081234567890', alamat: 'Jl. Merdeka No. 10, Palembang', status_akun: 1 },
      { id: 3, nama: 'Susi Susanti',    email: 'susi@gmail.com', password: hash, role: 'PENYEWA', no_telp: '081234567891', alamat: 'Jl. Sudirman No. 5, Palembang',  status_akun: 1 },
      { id: 4, nama: 'Alan Budikusuma', email: 'alan@gmail.com', password: hash, role: 'PENYEWA', no_telp: '081234567892', alamat: 'Kertapati, Palembang',            status_akun: 1 },
    ];
